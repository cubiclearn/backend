...
contract CredentialsFactory {
    ...
    function createCourse(string memory _name, string memory _symbol, string memory _bUri, uint256 maxSupply)
        external
        returns (address, address)
    {
        ...
        address karmaAccessControl = address(new KarmaAccessControluint64(CredentialsBurnable(creds), msg.sender));
